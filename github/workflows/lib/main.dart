...
class _HomeScreenState extends State<HomeScreen> {
  ...
  double _faultCurrent = 5000; // I (A)
  double _pickupCurrent = 400; // Is (A)
  double _tms = 0.2; // TMS

  // Gerilim Düşümü Parametreleri
  double _cableLength = 120; // Metre
  double _loadCurrent = 63;  // Amper
  double _cableSection = 16; // mm2
  ...
  double get _voltageDropPercent {
    ...
    final deltaU = sqrt(3) * _loadCurrent * r * 0.85; // cosPhi ~ 0.85
